...
class UserService:
    ...
    @staticmethod
    async def register_user(db: AsyncSession, telegram_id: int, username: str = None,
                           first_name: str = None, last_name: str = None) -> User:
        """Регистрация нового пользователя"""
        return await UserRepository.get_or_create_user(db, telegram_id, username, first_name, last_name)
    ...
    @staticmethod
    async def get_users_for_notification(db: AsyncSession, category_ids: List[int]) -> List[User]:
