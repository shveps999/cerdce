from sqlalchemy import String, Text, DateTime, Boolean, ForeignKey, Table, func, Column, Integer, Enum, BigInteger
...
class User(Base, TimestampMixin):
    ...
    id: Mapped[int] = mapped_column(BigInteger(), primary_key=True)  # ID пользователя в Telegram
...
class Post(Base, TimestampMixin):
    ...
    moderation_records: Mapped[List["ModerationRecord"]] = relationship(back_populates="post")
