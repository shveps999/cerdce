...
class ModerationRepository:
    ...
    @staticmethod
    async def get_moderation_history(db: AsyncSession, post_id: int) -> List[ModerationRecord]:
    ...
    @staticmethod
    async def get_moderator_actions(db: AsyncSession, moderator_id: int) -> List[ModerationRecord]:
        result = await db.execute(
            select(ModerationRecord)
    ...
    @staticmethod
    async def get_actions_by_type(db: AsyncSession, action: ModerationAction) -> List[ModerationRecord]:
        result = await db.execute(
            select(ModerationRecord)
